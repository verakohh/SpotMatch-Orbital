...
// const fetchMoreTracks = async () => {
    ...
    //         await fetchData(); // Refetch data if run out of tracks
    //     } else {
    //         console.log(trackIndex)
    //         console.log(allTracks[trackIndex])

    //         setRecommendedTracks(allTracks.slice(trackIndex, trackIndex + 20));
    //         setTrackIndex(trackIndex + 20);
    //         console.log("at else")
    //         console.log("after the slicing index: ",trackIndex)
    //         console.log("recommended tracks: ", recommendedTracks)
    //         console.log(trackIndex)
    //         console.log(allTracks[trackIndex])
    //         console.log(allTracks[trackIndex + 19])
    ...
    // useEffect(() => {
    //     if (!loading && recommendedTracks.length === 0) {
    //         fetchMoreTracks();
    //     }
    // }, [recommendedTracks, loading]);
    
    // const handleTapCard = (cardIndex) => {
    //     const track = recommendedTracks[cardIndex];
